/// @function draw_nine_slice(sprite, x, y, width, height, stretched)
/// @args sprite,x,y,width,height,stretched
function draw_nine_slice(argument0, argument1, argument2, argument3, argument4, argument5) {
